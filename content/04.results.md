...
To showcase these commands, we projected annotations for all haplotypes in the latest draft human pangenome (HPRC v1.1 GRCh38-based Minigraph-Cactus pangenome)[@hprc] into the pangenome (see [Projecting annotations into a pangenome]). 
